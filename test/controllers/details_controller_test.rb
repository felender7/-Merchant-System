...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { address_1: @detail.address_1, address_2: @detail.address_2, address_3: @detail.address_3, email: @detail.email, phone: @detail.phone, shop_name: @detail.shop_name } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { address_1: @detail.address_1, address_2: @detail.address_2, address_3: @detail.address_3, email: @detail.email, phone: @detail.phone, shop_name: @detail.shop_name } }
